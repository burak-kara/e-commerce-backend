...
urlpatterns = [
    ...
    path('api/advertisements/', views.AdvertisementList.as_view()),
    path('api/recommended-adds/', views.RecommendedAdds.as_view()),
    ...
    # user status update
    path('api/admin-user-update/<int:pk>/',
         views.updateUserMgrChange.as_view()),
    # intervals - COMING SOON
    # Total price
    path('api/getPrice/', views.TotalPriceList.as_view()),
